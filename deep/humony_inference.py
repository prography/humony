...
parser.add_argument('--inference_dir', type=str, default='./dataset/inference_output',
                    help='Path to the directory to generate the inference results')

parser.add_argument('--output_dir', type=str, default='./dataset/segmentation_output',
                    help='Path to the directory to generate the inference results')
...
def humony(image_path):
  ...
  mask_filename = image_basename + '_mask.png'
  path_to_mask = os.path.join(inference_dir, mask_filename)
  output_filename = image_basename + '_segment.png'
